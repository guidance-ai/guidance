...
@guidance
def block(lm, name=None, open_text="", close_text=""):
    ...
    def __exit__(lm, exc_type, exc_value, traceback):
        _rec_close(lm, open_text, close_text, text_name=name, text_offset=offset)
...
def _rec_close(lm, open_text, close_text, text_name=None, text_offset=0):
