...
block_command <<= (
    block_command_open
    + SavedText(pp.Group(block_command_content)("block_content"))
    + block_command_close
).leave_whitespace()
block_command = SavedText(pp.Group(block_command)("block_command")).set_name(
    "block_command"
)
