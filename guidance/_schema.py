...
class TokenUsage(BaseModel):
    ...
    """Number of tokens used as input to the model."""

    cached_tokens: NonNegativeInt = 0
    """Number of input tokens that were already in the KV cache."""

    round_trips: NonNegativeInt = 0
    """Number of actual forward passes through the model."""

    output_tokens: NonNegativeInt = 0
    """Number of tokens generated by the model. Approximately equal to the number
    of round trips plus the number of fast-forwarded tokens, but may be slightly
    smaller if some forward-passes did not generate any tokens (e.g. if they were
    just used to pre-fill or get probabilities for visualization)."""
