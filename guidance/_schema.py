...
class TokenLatency(BaseModel):
    total_ms: Annotated[float, Ge(0)] = 0.0
    ...
    def avg_ms(self) -> float:
        ...
        if self.token_count == 0:
            return 0.0
        return self.total_ms / self.token_count

    def __add__(self, other: "TokenLatency") -> "TokenLatency":
        return TokenLatency(
...
class TokenUsage(BaseModel):
    ...
    latency: TokenLatency = Field(default_factory=TokenLatency)
    """Latency of output tokens"""
