...
class TokenUsage(BaseModel):
    ...
    """Number of tokens generated by the model. Approximately equal to the number of round trips plus the number of fast-forwarded tokens, but may differ"""
    ...
    def token_savings(self) -> Annotated[float, Ge(0), Le(1)]:
        ...
        """
        return self.ff_tokens / self.output_tokens if self.output_tokens > 0 else 0.0
