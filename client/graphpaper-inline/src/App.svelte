...
<div class="w-full min-h-72">
  <nav class="sticky top-0 z-50 opacity-90">
    ...
    <section>
      <div class="text-sm pt-2 pb-2 flex border-b border-gray-200">
        <div class="ml-4 mr-4 inline-flex justify-between items-center hover:bg-gray-700 hover:text-white" tabindex="-1"
        ...
        <Select values={["None", "Type", "Probability", "Latency (ms)"]} classes="bg-gray-200" defaultValue={"Type"}
  ...
  <section class="w-full">
    <TokenGrid textComponents={textComponents} tokenDetails={tokenDetails} isCompleted={isCompleted} isError={isError}
               bgField={bgField} underlineField={underlineField} requireFullReplay="{requireFullReplay}" />
  </section>
</div>