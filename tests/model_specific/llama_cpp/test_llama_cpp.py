...
def test_llama_cpp_select2(llamacpp_model: Model):
    lm = llamacpp_model
...
def test_repeat_calls(llamacpp_model: Model, selected_model_name: str):
...
def test_suffix(llamacpp_model: Model):
    llama2 = llamacpp_model
...
def test_subtoken_forced(llamacpp_model: Model):
    llama2 = llamacpp_model
...
def test_llama_with_temp(llamacpp_model: Model):
    lm = llamacpp_model
...
def test_llama_with_temp2(llamacpp_model: Model):
    lm = llamacpp_model
...
def test_max_tokens(llamacpp_model: Model):
    lm = llamacpp_model
