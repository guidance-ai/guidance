...
class TestDateTime:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            '"1998-12-31T23:58:60Z"',  # an invalid date-time with leap second on a wrong minute, UTC
            '"1998-12-31T22:59:60Z"',  # an invalid date-time with leap second on a wrong hour, UTC
